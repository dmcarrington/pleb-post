...
import LayoutCenter from "../src/components/layout/layout-center";
...
function LoginFooter({ callbackUrl }) {
  return (
    <small className="font-weight-bold text-muted pt-4">
      Don't have an account?{" "}
      <Link href={{ pathname: "/signup", query: { callbackUrl } }}>
        sign up
      </Link>
    </small>
  );
